...
1. COMPOSITON - allows us to create assosiation between objects
2. Allows to create a connection between employee object and shift object.
3. For each employye we will creata a shift object.
4. 
"""
