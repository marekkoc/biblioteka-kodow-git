...
8. Nadal mamy problem z "duplicate code". Rozwiązemy to za pomoca encapsulation.
    (e.first_name i e.last_name jest drukowane w obu funkcjach)

"""
from employee2 import Manager
from employee2 import Attendant
from employee2 import Cook
from employee2 import Mechanic
