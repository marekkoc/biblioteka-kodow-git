...
from PyQt5.QtGui import QPen, QBrush, QColor, QTransform, QPainter
import sys
import json
...
class TreeGraphicsScene(QGraphicsScene):
    def __init__(self):
        ...
        self.colors = {
            ...
            'drink': QColor(150, 75, 75),    # Czerwonawy
            'ingredient': QColor(75, 75, 150), # Niebieski
            'animal': QColor(75, 150, 75),    # Zielony
            'default': QColor(128, 128, 128)  # Szary
        }

    def draw_tree(self, node, x=0, y=0, level=0):
        # Wybór koloru bazując na typie węzła
